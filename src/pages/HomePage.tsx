    ...
    >
      ...
      <section className="bg-gradient-to-r from-blue-600 to-purple-700 text-white">
        <div className="container mx-auto px-4 py-20">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">            <div className="space-y-6">              <h1 className="text-4xl md:text-6xl font-bold leading-tight">
                Latest Gadgets & <span className="text-yellow-300">Tech Accessories</span>
              </h1>
              <p className="text-xl text-blue-100">
                Discover cutting-edge technology and innovative gadgets. 
                From smartphones to smart watches, we have everything you need. 
              ...
              <div className="flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-4">
                ...
                <Link
                  to="/products?category=Mobile%20%26%20Accessories"
      ...
      {/* Features Section */}
      <section className="py-16 bg-gray-50">        <div className="container mx-auto px-4">
      ...
      <section className="py-16 bg-blue-600 text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <form className="max-w-md mx-auto flex">
            ...
            <button
              type="submit"
              className="bg-yellow-500 text-gray-900 px-6 py-3 rounded-r-lg font-semibold hover:bg-yellow-400 transition-colors"
            >
              Subscribe
            </button>
          </form>
