    ...
    <AnimatePresence>
      {isOpen && (
        ...
        >
          {/* Overlay */}
          <motion.div
            className="fixed inset-0 bg-gradient-to-r from-black/60 to-black/40 backdrop-blur-sm"
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
            exit={{ opacity: 0 }}
          ...
          {/* Drawer */}
          <motion.div
            className="relative w-full max-w-md bg-white h-full shadow-2xl z-50"
            initial={{ x: '100%' }}
            animate={{ x: 0 }}
            exit={{ x: '100%' }}
                  ...
                  <div className="p-4 space-y-3">
                    {cart.map((item) => (
                      ...
                      >
                        ...
                        {/* Product Details and Price/Remove */}
                        <div className="flex-1 min-w-0 flex flex-col sm:flex-row sm:items-center sm:justify-between">
                          ...
                          {/* Price and Remove */}
                          <div className="flex flex-col items-end space-y-2 mt-2 sm:mt-0 sm:ml-4">
